...
class CustomerInfo:
    def __init__(self, root):
        ...
        # display message
        self.label = Label(top, font=('Times New Roman', 50, 'bold'), text="LIST OF CUSTOMER", fg="black", anchor="center")
        self.label.grid(row=0, column=3, padx=10, pady=10)

        # display message
        self.name_label = Label(left, font=('arial', 20, 'bold'), text="NAME", fg="black", anchor="center")
        ...
        # display message
        self.room_no_label = Label(right, font=('arial', 20, 'bold'), text="ROOM NO", fg="black", anchor="center")
        ...
        # create home button
        self.home_button = Button(top, text="HOME", font=('', 15), bg="white", relief=RIDGE, height=2, width=15,
        ...
        self.display_button = Button(top, text="DISPLAY", font=('', 15), bg="white", relief=RIDGE, height=2, width=15,
