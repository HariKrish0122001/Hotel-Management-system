...
class GetInfo:
    def __init__(self, root):
        ...
        # display message
        self.label = Label(top, font=('arial', 50, 'bold'), text="INFORMATION OF CUSTOMER", fg="black",
                           anchor="center")
        ...
        self.submit_button = Button(button_frame, text="SUBMIT", font=('', 15), bg="white", relief=RIDGE, height=2,
                                    width=15, fg="black", anchor="center", command=get_info)
        self.submit_button.grid(row=8, column=2, padx=10, pady=10)

        # create home button
        self.home_button = Button(button_frame, text="HOME", font=('', 15), bg="white", relief=RIDGE, height=2,
