...
class CheckOut:
    def __init__(self, root):
        ...
        # display message
        self.label = Label(top, font=('Times New Roman', 50, 'bold'), text="CHECK OUT", fg="black", anchor="center")
        self.label.grid(row=0, column=3, padx=10, pady=10)

        # room no label
        self.room_no_label = Label(bottom, font=('arial', 20, 'bold'), text="ENTER THE ROOM NUMBER :", fg="black",
                                   anchor="center")
        ...
        self.check_out_button = Button(bottom, text="CHECK OUT", font=('', 15), bg="white", relief=RIDGE, height=2,
                                       width=15,
                                       fg="black", anchor="center", command=check_out)
        self.check_out_button.grid(row=3, column=2, padx=10, pady=10)

        # create submit button
        self.home_button = Button(bottom, text="HOME", font=('', 15), bg="white", relief=RIDGE, height=2, width=15,
